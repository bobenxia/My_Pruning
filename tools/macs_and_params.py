...
def get_model_macs_and_params(model: nn.Module, image_size: tuple, gpu_id: int = 0) -> Tuple[float, float]:
    """
    ...
    macs, params = get_model_complexity_info(model, image_size, as_strings=True,
